                    ...
                    KRefreshScrollView(progressTint: .purple, arrowTint: .purple) {
                        ...
                        ForEach(viewModel.saleGoodsItems.reversed(), id: \._id){ saleGoodsItem in
                            ...
                            NavigationLink(destination: GoodsDetailViewScreen(goodsItem: saleGoodsItem), label: {
                                GoodsItemView(title: saleGoodsItem.title, price: saleGoodsItem.price, tags: saleGoodsItem.tags, wishCount: saleGoodsItem.wishCount, chat: saleGoodsItem.chat, state: saleGoodsItem.state, image: saleGoodsItem.image)
                            })
                        }
                    ...
                    KRefreshScrollView(progressTint: .purple, arrowTint: .purple) {
                        ...
                        ForEach(viewModel.soldGoodsItems.reversed(), id: \._id){ soldGoodsItem in
                            ...
                            NavigationLink(destination: DetailGoodsScreen(goodsItem: soldGoodsItem), label: {
                                GoodsItemView(title: soldGoodsItem.title, price: soldGoodsItem.price, tags: soldGoodsItem.tags, wishCount: soldGoodsItem.wishCount, chat: soldGoodsItem.chat, state: soldGoodsItem.state, image: soldGoodsItem.image)
                            })
                        }
                    ...
                    KRefreshScrollView(progressTint: .purple, arrowTint: .purple) {
                        ...
                        ForEach(viewModel.hidingGoodsItems.reversed(), id: \._id){ hidingGoodsItem in
                            ...
                            NavigationLink(destination: GoodsDetailViewScreen(goodsItem: hidingGoodsItem), label: {
                                GoodsItemView(title: hidingGoodsItem.title, price: hidingGoodsItem.price, tags: hidingGoodsItem.tags, wishCount: hidingGoodsItem.wishCount, chat: hidingGoodsItem.chat, state: hidingGoodsItem.state, image: hidingGoodsItem.image)
                            })
                        }
